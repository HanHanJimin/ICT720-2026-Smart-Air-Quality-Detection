...
| 3 | AI & Voice Stack | Google Gemini API (text), gTTS, Python | Handle voice interactions, fetch historical data from Firebase, and display real-time information via voice |
